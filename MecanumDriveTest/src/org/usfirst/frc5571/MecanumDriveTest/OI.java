...
public class OI {
    ...
    public boolean A_Button, B_Button, X_Button, Y_Button, Bumper_L, Bumper_R;
    public double yAxis, xAxis, zAxis, xboxThrottle, xboxTwist, left_xAxis,
	left_yAxis, right_xAxis, right_yAxis, DPAD_LR, trigger_axis;
...
public NetworkTable table;
	...
	public void updateStatusOI() {
		...
		trigger_axis = xboxController.getRawAxis(3);
		...
		SmartDashboard.putNumber("Trigger Axis:", trigger_axis);
