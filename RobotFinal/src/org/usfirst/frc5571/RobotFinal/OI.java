...
public class OI {
    ...
    public JoystickButton bumper_L;
    public JoystickButton bumpr_R;
    ...
    public OI() {
        ...
        bumpr_R = new JoystickButton(xboxController, 4);
        bumpr_R.whileHeld(new ElevatorUp());
        bumper_L = new JoystickButton(xboxController, 3);
        bumper_L.whileHeld(new ElevatorDown());
        b_Button = new JoystickButton(xboxController, 2);
        b_Button.whileHeld(new ElevatorUp());
        a_Button = new JoystickButton(xboxController, 1);
        a_Button.whileHeld(new ElevatorDown());
